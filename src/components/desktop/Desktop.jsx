...
export default function Desktop({ ...props }) {
  ...
  const [turnLightOn, setTurnLightOn] = useState(false);
  ...
  useEffect(() => {
    Object.entries(actions)[57][1].play(); // The laptop screen rotation animation
  }, [actions]);
            ...
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              >
                <mesh
                  ...
                  material={materials.negro}
                />
                {screenTurnedOn && <DesktopScreenComponent />}
              </group>
              <group
                name="Papel_1"
              ...
              <group
                onClick={() => setScreenTurnedOn(!screenTurnedOn)}
                name="Raton_21"
